...
// case class Params (
//   val iteration_imputation0_results: String = "s3://datasci-scantle/unified_ncs/experiments/2105_tuner/iteration_1/results/",
//   val focal_bsm: String =  "s3://datasci-scantle/unified_ncs/2105/inputs/focal_bsm/*",
//   val complete_taxonomy_df: String =  "s3://datasci-scantle/unified_ncs/2105/lifo/metadata/complete_taxonomy_indexed",
//   val distributions_df: String =  "s3://datasci-scantle/unified_ncs/2105/lifo/metadata/distributions",
//   val valid_respondents: String =  "s3://datasci-scantle/unified_ncs/2105/bsm/data/validRespondents",
...
case class Params (
  val iteration_imputation0_results: String = "s3://datasci-scantle/unified_ncs/experiments/2105_tuner/iteration_2/results/",
  val focal_bsm: String =  "s3://datasci-scantle/unified_ncs/2105/inputs/focal_bsm/*",
  val complete_taxonomy_df: String =  "s3://datasci-scantle/unified_ncs/2105/lifo/metadata/complete_taxonomy_indexed",
  val distributions_df: String =  "s3://datasci-scantle/unified_ncs/2105/lifo/metadata/distributions",
  val valid_respondents: String =  "s3://datasci-scantle/unified_ncs/2105/bsm/data/validRespondents",
...
val distribution0 = spark.read.option("header",true).option("inferSchema",true).csv(params.iteration_imputation0_results + "{" + attributes.mkString(",") + "}/{" + attributes.mkString(",") + "}_distributions")
...
val dists0 = distribution0.drop("value").withColumn("bounded", ($"imputed_distribution" >= $"lower_bound_distribution") and ($"imputed_distribution" <= $"upper_bound_distribution")).withColumn("iteration", lit(iteration))
...
dists0.repartition(1).write.mode("overwrite").option("header",true).csv(params.outDir + "summaries/univariate_distributions/iteration_" + iteration)
